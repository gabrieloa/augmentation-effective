...
df <- read.csv('/home/Data/augmentation-effective/analyses_logistic/heatmap_ba.csv')
...
graphic
ggsave('/home/Data/augmentation-effective/analyses_logistic/heatmap_logistic.pdf', 
       plot=graphic, 
       width = 15, 
       height = 10, 
       dpi = 300)
