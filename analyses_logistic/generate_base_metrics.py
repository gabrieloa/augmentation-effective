...
for d in ['app_reviews', 'hatespeech', 'sentiment', 'womens']:
    for sample in [500, 2000]:
        ...
        for k in tqdm(range(50)):
            ...
            matrix = {}
            for ind in range(2):
                with open(f'{experiment_folder}/{d}/logbase_{sample}_{k}_rep{ind}.pkl', 'rb') as file:
                ...
                models_dict[ind] = {'matrix': matrix,
                                                ...
                                                'auc': auc}
                with open(f'{experiment_folder}/{d}/metrics_base_log_{sample}_{k}.pkl', 'wb') as file:
